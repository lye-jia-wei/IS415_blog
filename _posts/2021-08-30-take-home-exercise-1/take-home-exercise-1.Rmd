...
Note that this map is incomplete and is solely for understanding of data.
...
tm_shape(Jakarta_Covid_Cases) +
  ...
  tm_layout(legend.show = TRUE,
            ...
            title.size = 50,main.title = "Cumulative Confirmed Cases per 10k population In Jakarta Sub-District From March 2020 to July 2021", legend.outside = FALSE,legend.width = 0.70, legend.text.size = 1.90, legend.title.size = 1.80, legend.position = c("left", "bottom"), panel.label.size = 2.5) +
  tm_compass(type="4star", size = 4) + 
  tm_scale_bar(width = 0.15,text.size = 1.90)+
...
legend.is.portrait = TRUE) +
tm_borders(alpha = 0.5) +
tm_layout(legend.outside = FALSE,legend.title.size = 2.90, legend.text.size = 2.60,
            legend.position = c("left", "bottom"),
            frame = TRUE)+
  tm_compass(type="4star", size = 8) + 
  tm_scale_bar(width = 0.15,text.size = 1.50)+
...
Cumulative Death per 10k population In Jakarta Sub-District
...
tm_shape(Jakarta_Death) +
  ...
  tm_facets(by="Date", 
            free.coords=TRUE, 
            drop.shapes=TRUE) +
  tm_layout(legend.show = TRUE, legend.outside = FALSE,legend.width = 0.70, legend.text.size = 1.90, legend.title.size = 1.90, legend.position = c("left", "bottom"), panel.label.size = 2.5) +
  tm_compass(type="4star", size = 4) + 
  tm_scale_bar(width = 0.15,text.size = 1.90)+
  tm_grid(lwd = 0.1, alpha = 0.2,labels.size=1.50) +
  tm_borders(alpha = 0.5)
