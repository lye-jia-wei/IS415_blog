...
#### 6.1.5 NA, Geometric Validity Checks and Correction
...
#### 6.1.5 Translating column name for DKI_Jakarta to English
...
#### 12.1 Cumulative Confirmed Cases 
...
#### 12.1.2 Plotting Choropleth Map of Monthly Cumulative Confirmed Cases 
...
#### 12.1.3 Time-series choropleth map of COVID-19 Rates
...
tmap_animation(Covd_Cases_Animation, delay = 45)
```

```{r, fig.cap="Time-series choropleth map of COVID-19 Rates",fig.show = 'animate', ffmpeg.format = 'gif'}
...
```{r echo=TRUE, eval=TRUE, fig.show = 'animate', ffmpeg.format = 'gif'}
